...
public enum TargetType { FriendlyPiece, EnemyPiece, FriendlyEnemyPiece, FriendlyTile, EnemyTile, FriendlyEnemyTile, MyTeam, EnemyTeam } // After selecting a card, this will determine what targets you can choose from
